...
public class Department {
    ...
    public Department(int id, int cid, int department_percount, String department_name, String department_number, String department_person, String department_headphone, String create_time, String state, String remake) {
        this.id = id;
        this.cid = cid;
